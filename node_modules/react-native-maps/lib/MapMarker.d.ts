...
import { MapManagerCommand, NativeComponent, ProviderContext, UIManagerCommand } from 'react-native-maps/lib/decorateMapComponent';
import { MapMarkerNativeComponentType } from 'react-native-maps/lib/MapMarkerNativeComponent';
import { CalloutPressEvent, LatLng, MarkerDeselectEvent, MarkerDragEvent, MarkerDragStartEndEvent, MarkerPressEvent, MarkerSelectEvent, Point } from 'react-native-maps/lib/sharedTypes';
