...
import { ProviderContext, NativeComponent, MapManagerCommand, UIManagerCommand } from 'react-native-maps/lib/decorateMapComponent';
import { PolygonPressEvent } from 'react-native-maps/lib/MapPolygon.types';
import { LatLng, LineCapType, LineJoinType } from 'react-native-maps/lib/sharedTypes';
